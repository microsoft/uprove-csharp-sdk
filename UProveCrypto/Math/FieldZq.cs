...
namespace UProveCrypto.Math
{
    ...
    public abstract class FieldZq
    {
        ...
        // stores precomputed NegativeOne element.
        private FieldZqElement _negativeOne = null;

        /// <summary>
        /// The field element negative one.
        /// </summary>
        public FieldZqElement NegativeOne
        {
            get
            {
                if (this._negativeOne == null)
                {
                    this._negativeOne = One.Negate();
                }
                return _negativeOne;
            }
        }
        ...
        public FieldZqElement GetElement(int value)
        {
            if (value < 0)
            {
                return this.GetElement(0 - value).Negate();
            }
            else
            {
                return this.GetElement((uint)value);
            }
        }
        ...
        public abstract FieldZqElement GetElement(uint value);
