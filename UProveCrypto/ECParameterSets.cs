...
namespace UProveCrypto
{
    ...
    public static class ECParameterSets
    {
        ...
        public const string ParamSet_EC_BN254_V1Name = "1.3.6.1.4.1.311.75.1.3.1";
        ...
        static ECParameterSets()
        {
            ...
            ECParameterSets.ParamSet_EC_BN254_V1 = new ParameterSet(
                ECParameterSets.ParamSet_EC_BN254_V1Name,
                BN254.Gq,
                BN254.IssuerGenerators,
                BN254.Gd);
        ...
        public static ParameterSet ParamSet_EC_BN254_V1 { get; private set; }
...
0xb2
        ...
        static class BN254
        {
            ...
            static readonly byte[] p = {
0x25, 0x23, 0x64, 0x82, 0x40, 0x00, 0x00, 0x01,
...
0x01
            ...
            // g1 (counter = 2)
            static readonly byte[] g1_x = {
0x1d, 0x1b, 0x32, 0xc4, 0x2c, 0xbc, 0x9b, 0x27,
0x94, 0xaa, 0x85, 0x23, 0x08, 0x79, 0xe7, 0x89,
0xe8, 0xef, 0xd0, 0xf4, 0xb0, 0xc1, 0x7d, 0x0d,
0xfb, 0x2f, 0x40, 0x65, 0x7c, 0x80, 0xa8, 0xce
};
            static readonly byte[] g1_y = {
0x01, 0x7a, 0xd2, 0xb2, 0xac, 0xc3, 0x1a, 0x4a,
0xe1, 0x65, 0xd9, 0xae, 0x32, 0xcf, 0xc9, 0x92,
0x39, 0xf7, 0x11, 0x36, 0x0a, 0x52, 0xa8, 0x00,
0x52, 0x43, 0xec, 0xa6, 0xe3, 0x16, 0x29, 0x8a
};

            // g2 (counter = 1)
            static readonly byte[] g2_x = {
0x0c, 0x2d, 0x7a, 0x7a, 0xfa, 0xfc, 0x4b, 0x87,
0xdd, 0xec, 0xbe, 0x83, 0xff, 0x8e, 0xb3, 0xb7,
0xcc, 0x43, 0x8c, 0xc5, 0xb4, 0x78, 0x23, 0x7a,
0x58, 0xfb, 0x15, 0xbe, 0x89, 0xea, 0x08, 0xa4
};
            static readonly byte[] g2_y = {
0xde, 0x4b, 0x4a, 0x6d, 0x14, 0x96, 0xf1, 0x80,
0xb6, 0x0c, 0xc5, 0x55, 0x97, 0x51, 0xa2, 0x1d,
0x46, 0xa8, 0xc4, 0x74, 0xc3, 0xed, 0xab, 0xcd,
0x06, 0xd9, 0x6b, 0x77, 0x9d, 0xee, 0x28
};

            // g3 (counter = 0)
            static readonly byte[] g3_x = {
0x17, 0x53, 0x9f, 0x9a, 0x6e, 0x9e, 0x8d, 0xba,
0x4b, 0xe6, 0xcb, 0x04, 0xc6, 0x23, 0x6a, 0x04,
0x42, 0x60, 0xe7, 0xfc, 0x93, 0x11, 0xe3, 0x54,
0xed, 0x25, 0xf6, 0x30, 0xb2, 0xeb, 0x20, 0x30
};
            static readonly byte[] g3_y = {
0x05, 0x42, 0x7b, 0x25, 0x71, 0x70, 0x65, 0x81,
0xd9, 0xe4, 0x46, 0x67, 0xe0, 0xc9, 0xcf, 0x0a,
0xe4, 0xa2, 0x15, 0x37, 0x31, 0x1e, 0xbe, 0x14,
0x9c, 0x8b, 0xa7, 0xe2, 0x3a, 0xe7, 0x36, 0xee
};

            // g4 (counter = 0)
            static readonly byte[] g4_x = {
0x03, 0x30, 0x97, 0xf7, 0xf3, 0x51, 0xdb, 0x0f,
0xa9, 0xd5, 0x16, 0x2c, 0x38, 0xb9, 0xfe, 0xe3,
0x5d, 0xf1, 0xca, 0x9f, 0x7d, 0xb7, 0x3f, 0xa4,
0xab, 0xfe, 0xa3, 0x48, 0xb1, 0xb3, 0x51, 0x81
};
            static readonly byte[] g4_y = {
0x08, 0xb2, 0xbd, 0x96, 0x50, 0x0d, 0x28, 0x34,
0xd1, 0x6b, 0xe3, 0x6d, 0x11, 0x17, 0xc4, 0x13,
0xf7, 0xb3, 0xbd, 0x4d, 0x39, 0x49, 0x53, 0x45,
0xcc, 0x0c, 0xdb, 0x58, 0x94, 0xe9, 0x7e, 0x67
};

            // g5 (counter = 1)
            static readonly byte[] g5_x = {
0x04, 0x43, 0x22, 0xc0, 0x04, 0x44, 0x79, 0x89,
0x3f, 0x8c, 0x1e, 0x52, 0xf3, 0xe1, 0x08, 0x90,
0x8a, 0xd7, 0x9e, 0x82, 0x15, 0xcc, 0x81, 0xfc,
0xfb, 0x53, 0xa0, 0xc3, 0x5c, 0x01, 0xd7, 0x38
};
            static readonly byte[] g5_y = {
0x01, 0x34, 0x9a, 0xfc, 0x6d, 0xc3, 0x54, 0x93,
0xbc, 0x65, 0x73, 0x2b, 0xa3, 0x28, 0x32, 0xc5,
0x63, 0x37, 0x42, 0x76, 0xd4, 0x06, 0xdb, 0xec,
0x33, 0xd1, 0xed, 0xf5, 0xb3, 0xbb, 0xca, 0x37
};

            // g6 (counter = 0)
            static readonly byte[] g6_x = {
0x54, 0x77, 0x2c, 0x17, 0x1c, 0xf3, 0x48, 0xb7,
0x80, 0xb1, 0x9e, 0x3c, 0xeb, 0xaf, 0xf4, 0x49,
0xda, 0xe2, 0xec, 0x46, 0x99, 0xde, 0x0d, 0x23,
0xa5, 0x68, 0x87, 0x38, 0x71, 0x01, 0xad
};
            static readonly byte[] g6_y = {
0x02, 0xb5, 0x06, 0xeb, 0xf5, 0x6e, 0x76, 0x3f,
0x39, 0x4e, 0x8d, 0x86, 0x5f, 0xd5, 0x12, 0x43,
0x9a, 0x70, 0xa2, 0x33, 0x79, 0xfc, 0xce, 0xd2,
0x86, 0x43, 0xda, 0x6e, 0xaf, 0x1c, 0x08, 0xed
};

            // g7 (counter = 0)
            static readonly byte[] g7_x = {
0x10, 0x31, 0xb5, 0xaf, 0xbf, 0x71, 0xad, 0xff,
0x9c, 0x9b, 0xad, 0xbb, 0x1e, 0xb4, 0xba, 0x8c,
0xf1, 0x0e, 0xb0, 0xdb, 0xbf, 0xf0, 0xc3, 0x9f,
0xcc, 0x7f, 0x4e, 0x6a, 0x65, 0x6e, 0xb8, 0xf1
};
            static readonly byte[] g7_y = {
0x0e, 0x62, 0x54, 0x04, 0x83, 0x27, 0x4a, 0x67,
0x18, 0x41, 0x62, 0xb6, 0xdd, 0xfe, 0x71, 0x40,
0x5a, 0x48, 0x77, 0xd0, 0xa3, 0x33, 0x5b, 0xfb,
0x4c, 0x12, 0x19, 0x59, 0x27, 0xf6, 0x44, 0xc9
};

            // g8 (counter = 1)
            static readonly byte[] g8_x = {
0x10, 0x0f, 0xe8, 0xc3, 0x88, 0x6e, 0xf7, 0x01,
0x78, 0x0b, 0x2d, 0x52, 0x3f, 0x7b, 0xe6, 0x3b,
0xca, 0x46, 0x8a, 0xf9, 0x79, 0x75, 0xf3, 0x42,
0xbb, 0xa7, 0x25, 0x46, 0x7a, 0x56, 0x33, 0xf8
};
            static readonly byte[] g8_y = {
0x12, 0x2b, 0xcf, 0xae, 0xf0, 0xe7, 0x4e, 0x43,
0xbb, 0x95, 0x2b, 0x6b, 0x46, 0xd3, 0xd9, 0x95,
0x69, 0x21, 0x02, 0x63, 0x58, 0xfa, 0x41, 0xfb,
0xff, 0xe0, 0xa1, 0x5f, 0xa9, 0x4c, 0x93, 0x0b
};

            // g9 (counter = 0)
            static readonly byte[] g9_x = {
0x20, 0xc9, 0x9d, 0xf3, 0x08, 0x5c, 0x88, 0xaf,
0x82, 0xec, 0x7c, 0xaf, 0xe4, 0xd5, 0x8b, 0x14,
0xa9, 0x56, 0x55, 0x07, 0xd0, 0x7b, 0x22, 0x6c,
0xaa, 0x05, 0x09, 0xac, 0xca, 0x96, 0x9a, 0xe1
};
            static readonly byte[] g9_y = {
0x04, 0xfc, 0x30, 0x46, 0x2c, 0x10, 0x5a, 0x62,
0x8a, 0x0b, 0xd6, 0x46, 0xac, 0x43, 0xc2, 0x7f,
0xf8, 0xec, 0xfc, 0xab, 0x98, 0x9a, 0x92, 0xab,
0xe5, 0x5c, 0xf0, 0xd8, 0x6f, 0xc2, 0xdc, 0x4a
};

            // g10 (counter = 0)
            static readonly byte[] g10_x = {
0x14, 0xad, 0x0d, 0x5a, 0xe6, 0xd6, 0x5a, 0x1f,
0xdd, 0x65, 0xe9, 0x0d, 0x2a, 0xd0, 0x0c, 0x76,
0x93, 0x51, 0xe4, 0x3c, 0x91, 0xaa, 0xb4, 0x26,
0x30, 0xc0, 0x32, 0xbf, 0x39, 0xbf, 0x96, 0x7d
};
            static readonly byte[] g10_y = {
0x08, 0x86, 0xec, 0x1b, 0x33, 0x73, 0x7f, 0x21,
0x79, 0xbb, 0x77, 0xa6, 0x47, 0xc1, 0x5f, 0x63,
0xaf, 0x8f, 0x05, 0x76, 0xfb, 0x34, 0xdd, 0x87,
0xf4, 0xc1, 0xab, 0x6d, 0x69, 0x8a, 0xa1, 0x38
};

            // g11 (counter = 3)
            static readonly byte[] g11_x = {
0x02, 0x68, 0x00, 0x2f, 0x38, 0xea, 0xb5, 0xc4,
0xf4, 0x6c, 0x95, 0x95, 0x8e, 0x77, 0xfa, 0x3f,
0xc1, 0x5d, 0x50, 0x3d, 0x1b, 0xe5, 0x01, 0xd3,
0xed, 0xcb, 0x6d, 0xcd, 0x49, 0x09, 0x7e, 0xb0
};
            static readonly byte[] g11_y = {
0x06, 0xc5, 0x77, 0x5f, 0xe8, 0x69, 0x53, 0x6f,
0xb2, 0xd5, 0x22, 0xfe, 0x62, 0x9d, 0x0a, 0x24,
0x3a, 0x8d, 0x58, 0x5d, 0xe7, 0x22, 0xb5, 0xf1,
0x10, 0x46, 0x60, 0x40, 0x7c, 0xca, 0x76, 0xad
};

            // g12 (counter = 1)
            static readonly byte[] g12_x = {
0x1d, 0x55, 0xdc, 0x62, 0x83, 0x42, 0xed, 0xea,
0x5f, 0x63, 0x4f, 0xe0, 0x25, 0xb4, 0x5d, 0x4d,
0x81, 0x47, 0x42, 0xe1, 0xf4, 0x6c, 0x6c, 0x7c,
0x29, 0x92, 0xa7, 0x85, 0x45, 0x65, 0x70, 0xbe
};
            static readonly byte[] g12_y = {
0x05, 0x28, 0x62, 0x3c, 0xb4, 0x3c, 0x1c, 0x62,
0x4e, 0x76, 0x22, 0x36, 0x76, 0x25, 0xac, 0xd4,
0x74, 0xc6, 0xd6, 0x6c, 0xef, 0xe6, 0xf9, 0x91,
0xdd, 0x61, 0x4e, 0xda, 0x6b, 0x61, 0x31, 0xd1
};

            // g13 (counter = 1)
            static readonly byte[] g13_x = {
0x0a, 0x2b, 0x72, 0x9e, 0x4c, 0xa1, 0x5c, 0xc3,
0xe5, 0x29, 0xed, 0xd3, 0xea, 0x1a, 0xb1, 0x37,
0x57, 0x15, 0x8a, 0x3c, 0x64, 0x4b, 0xca, 0xf8,
0x1f, 0xbf, 0xab, 0x46, 0x8d, 0x54, 0x70, 0x46
};
            static readonly byte[] g13_y = {
0x0a, 0xa1, 0xdb, 0x96, 0x29, 0x9d, 0x3e, 0x98,
0x4b, 0xe2, 0x77, 0xa6, 0xc2, 0x31, 0x1f, 0xba,
0xa1, 0xde, 0xb1, 0xa3, 0xa4, 0x4f, 0x06, 0x0f,
0xf7, 0x27, 0x0a, 0x1f, 0x2c, 0x12, 0x40, 0xc4
};

            // g14 (counter = 0)
            static readonly byte[] g14_x = {
0x16, 0x81, 0x76, 0x0a, 0xd3, 0xc3, 0xb3, 0x6d,
0xdb, 0x82, 0xf1, 0x66, 0x5c, 0x38, 0x2d, 0x84,
0x9e, 0xe3, 0xb8, 0x22, 0xd8, 0x93, 0x04, 0xda,
0xf0, 0x9f, 0x66, 0x1a, 0xb6, 0x0a, 0xa1, 0xf3
};
            static readonly byte[] g14_y = {
0x03, 0x6b, 0xc9, 0x97, 0x97, 0xbb, 0xfe, 0xb4,
0x4e, 0x2d, 0xbc, 0x44, 0xcb, 0x34, 0x27, 0xfc,
0x0c, 0xac, 0x13, 0xef, 0xb0, 0x7e, 0xf6, 0xba,
0xce, 0x90, 0x86, 0x8d, 0xdb, 0x49, 0x03, 0x1b
};

            // g15 (counter = 1)
            static readonly byte[] g15_x = {
0x0b, 0x63, 0x50, 0x7e, 0x15, 0x47, 0xa8, 0xb3,
0x86, 0x6e, 0x85, 0xf5, 0xc8, 0xaf, 0x22, 0x3b,
0xbc, 0x72, 0x59, 0x6f, 0xe9, 0xae, 0xcc, 0xbe,
0x5e, 0x81, 0xad, 0x90, 0xe6, 0x0b, 0x9c, 0x05
};
            static readonly byte[] g15_y = {
0x0e, 0xc9, 0xd3, 0xd4, 0x78, 0xe5, 0x9d, 0xb6,
0x61, 0xe0, 0x9a, 0xb3, 0x03, 0x44, 0x7c, 0xe6,
0x06, 0x05, 0xe8, 0x0b, 0xd2, 0xdd, 0xc6, 0xf9,
0x4e, 0x5d, 0x86, 0xf7, 0x8f, 0xdb, 0x38, 0x24
};

            // g16 (counter = 6)
            static readonly byte[] g16_x = {
0x04, 0xb5, 0x97, 0x83, 0x69, 0x4c, 0x96, 0x49,
0xb9, 0x83, 0x23, 0x00, 0x67, 0xfa, 0x2b, 0xf7,
0xf1, 0x55, 0xe8, 0x2c, 0xc4, 0x09, 0x0a, 0xe4,
0x3f, 0xdd, 0x62, 0xc3, 0xb0, 0x98, 0xa8, 0xcf
};
            static readonly byte[] g16_y = {
0x07, 0x0f, 0xa2, 0x5f, 0x33, 0xf7, 0x6f, 0x3f,
0x63, 0x5f, 0x5b, 0x4d, 0xe4, 0xed, 0x9c, 0xf4,
0xb4, 0x7f, 0x17, 0xef, 0x7a, 0x13, 0x9b, 0xa6,
0xc0, 0x32, 0xd2, 0x79, 0xaf, 0xa6, 0x57, 0x6c
};

            // g17 (counter = 4)
            static readonly byte[] g17_x = {
0x01, 0x1d, 0x40, 0x55, 0xfa, 0x4f, 0x18, 0xc0,
0xcc, 0x56, 0x15, 0x16, 0xa4, 0x6c, 0x34, 0x8d,
0x51, 0xcf, 0x1c, 0xb5, 0xb7, 0xbc, 0x21, 0x9a,
0xd6, 0x6c, 0x5c, 0xcf, 0x9f, 0xe3, 0x66, 0xc4
};
            static readonly byte[] g17_y = {
0x06, 0xa2, 0x2d, 0xba, 0xfb, 0x59, 0xd3, 0x4a,
0x3a, 0x9d, 0xde, 0xd5, 0x85, 0xcc, 0xdb, 0xec,
0xc5, 0xe5, 0xf3, 0x15, 0x74, 0x8a, 0xe2, 0x6d,
0xe9, 0x09, 0x47, 0x07, 0x72, 0x15, 0x92, 0x3d
};

            // g18 (counter = 1)
            static readonly byte[] g18_x = {
0x0d, 0x95, 0x63, 0xed, 0x3b, 0xd5, 0x75, 0x7c,
0x26, 0x33, 0xbd, 0x17, 0xa9, 0x98, 0xdb, 0x69,
0xbd, 0x22, 0x6c, 0xf0, 0xfa, 0x4e, 0x1f, 0x1d,
0x43, 0xad, 0xdc, 0x4e, 0x28, 0x8d, 0x10, 0xdd
};
            static readonly byte[] g18_y = {
0x01, 0x00, 0x5e, 0xa6, 0xbf, 0x73, 0x04, 0xa0,
0x31, 0x06, 0x9d, 0x89, 0x42, 0x94, 0xcd, 0x24,
0x63, 0xd5, 0x4b, 0x78, 0x22, 0x0b, 0xbb, 0xeb,
0xc9, 0x84, 0x09, 0x50, 0x6d, 0xdb, 0x60, 0x35
};

            // g19 (counter = 1)
            static readonly byte[] g19_x = {
0x1e, 0x91, 0xb4, 0xd7, 0x56, 0xa9, 0x08, 0x54,
0x7d, 0x4b, 0xe2, 0x99, 0x1d, 0x0b, 0x3f, 0xfc,
0xb4, 0xc2, 0xcb, 0x8e, 0x78, 0xbb, 0xfd, 0x02,
0x64, 0x5b, 0xf0, 0x91, 0xf8, 0x94, 0x09, 0xb4
};
            static readonly byte[] g19_y = {
0x12, 0x70, 0x7e, 0x8c, 0xb8, 0x18, 0xbb, 0x61,
0x15, 0x8c, 0x2d, 0xd2, 0xe6, 0xe0, 0x5a, 0x8c,
0x97, 0x0c, 0xd0, 0xef, 0x87, 0x86, 0xe0, 0x74,
0x00, 0xe4, 0xa5, 0x2b, 0xb5, 0xd1, 0x9f, 0x0e
};

            // g20 (counter = 0)
            static readonly byte[] g20_x = {
0x9d, 0x11, 0x85, 0x96, 0x76, 0x84, 0xcb, 0x70,
0xac, 0xa6, 0x8e, 0x16, 0x08, 0xb6, 0xae, 0x71,
0xcc, 0x54, 0x4a, 0x2c, 0xa2, 0xbd, 0x2f, 0xd2,
0x7f, 0xec, 0x72, 0x04, 0x54, 0xee, 0xa5
};
            static readonly byte[] g20_y = {
0x0c, 0x1e, 0x19, 0xeb, 0x80, 0xa9, 0xee, 0x44,
0xa6, 0x63, 0x64, 0x4d, 0xe4, 0x98, 0x80, 0xed,
0x23, 0x1f, 0x6d, 0xe5, 0xac, 0xd2, 0x88, 0x73,
0x45, 0xd5, 0x03, 0x7a, 0xe2, 0xf6, 0xde, 0xb8
};

            // g21 (counter = 1)
            static readonly byte[] g21_x = {
0x05, 0xed, 0x66, 0xe2, 0x28, 0xf0, 0xd4, 0xf2,
0x23, 0xdf, 0x6a, 0x99, 0xee, 0x1b, 0x7b, 0x55,
0x9d, 0x4b, 0x71, 0x1e, 0x13, 0x53, 0x2e, 0x0b,
0x7b, 0xab, 0x7c, 0x3b, 0x9b, 0x37, 0x73, 0x17
};
            static readonly byte[] g21_y = {
0x09, 0xe5, 0xfb, 0x71, 0xcf, 0x74, 0xb0, 0x83,
0xc4, 0xff, 0x94, 0x7a, 0x9e, 0x44, 0x38, 0x60,
0xcb, 0x5f, 0x57, 0x0f, 0x23, 0x62, 0x19, 0xc4,
0x2f, 0xd3, 0xb4, 0x09, 0x24, 0xf5, 0xc0, 0x93
};

            // g22 (counter = 0)
            static readonly byte[] g22_x = {
0x17, 0x2c, 0xfb, 0xf2, 0xfc, 0xb7, 0xff, 0x3e,
0xb5, 0x16, 0x4d, 0x47, 0xca, 0xa7, 0x87, 0x9f,
0x57, 0xd9, 0x33, 0x0f, 0x49, 0xfc, 0x7b, 0xb0,
0x6b, 0xf9, 0x5a, 0x10, 0xe3, 0xd3, 0xcc, 0x79
};
            static readonly byte[] g22_y = {
0x02, 0x34, 0xaa, 0x9b, 0x9d, 0x48, 0xd1, 0x0d,
0x32, 0xbd, 0x4f, 0x7d, 0xe4, 0x1b, 0x3e, 0x1f,
0x79, 0x21, 0x0e, 0xc9, 0x0c, 0x43, 0xff, 0x0d,
0x80, 0x22, 0xfe, 0xf7, 0xc8, 0x1d, 0x08, 0x87
};

            // g23 (counter = 0)
            static readonly byte[] g23_x = {
0x02, 0xb6, 0xf3, 0x37, 0x6c, 0x6e, 0x5b, 0xf0,
0xc8, 0xd8, 0x3c, 0x0c, 0xc7, 0xe3, 0xb3, 0xbd,
0x5d, 0xab, 0xce, 0x66, 0x56, 0xdb, 0x92, 0x9b,
0x8a, 0xe9, 0x6a, 0xdc, 0xb2, 0x8f, 0x39, 0x70
};
            static readonly byte[] g23_y = {
0x0b, 0x28, 0x05, 0xa6, 0x5a, 0x1b, 0x3b, 0x07,
0xea, 0xa9, 0xad, 0x26, 0xcd, 0x5e, 0x91, 0x07,
0xbb, 0xea, 0xab, 0x79, 0x99, 0x80, 0xef, 0x15,
0x15, 0xd9, 0x29, 0x02, 0x52, 0x61, 0xde, 0xe1
};

            // g24 (counter = 1)
            static readonly byte[] g24_x = {
0x1d, 0x44, 0xd8, 0x05, 0xc8, 0x7a, 0xc9, 0xed,
0x5b, 0xd9, 0x2e, 0x32, 0xb2, 0xe7, 0x1b, 0x4b,
0x97, 0x36, 0x66, 0xba, 0xf6, 0x8b, 0xdf, 0x2a,
0xb5, 0x90, 0x4d, 0x61, 0x30, 0xcf, 0xe9, 0x9e
};
            static readonly byte[] g24_y = {
0x0b, 0x77, 0x98, 0x7d, 0x1a, 0x0a, 0xe5, 0x1a,
0xa7, 0x58, 0x94, 0x0c, 0x74, 0xb2, 0x18, 0x32,
0xa3, 0x95, 0x0f, 0x7e, 0xb2, 0x10, 0x07, 0x10,
0x79, 0x50, 0x48, 0x1a, 0x86, 0x0e, 0xa3, 0x2b
};

            // g25 (counter = 0)
            static readonly byte[] g25_x = {
0x07, 0x85, 0x1e, 0x9c, 0x8a, 0x6f, 0xac, 0xc4,
0x6a, 0x32, 0x6a, 0x1a, 0xbf, 0x0d, 0x73, 0xec,
0x33, 0x2e, 0x8d, 0xa3, 0xc3, 0x8f, 0x2c, 0x68,
0xbb, 0x56, 0xfd, 0x5d, 0xc1, 0x69, 0xd7, 0xe6
};
            static readonly byte[] g25_y = {
0x0a, 0xd3, 0x26, 0x46, 0x59, 0xbc, 0xd3, 0x87,
0x66, 0x0b, 0x0c, 0x03, 0x22, 0x0f, 0xc1, 0xd2,
0xe3, 0x1b, 0xe6, 0x5f, 0x99, 0x8d, 0xdd, 0x13,
0x57, 0xc3, 0x77, 0xc5, 0x45, 0x49, 0xe7, 0x16
};

            // g26 (counter = 1)
            static readonly byte[] g26_x = {
0x10, 0x00, 0x25, 0xe9, 0x7c, 0x0b, 0xf1, 0x12,
0x52, 0x3b, 0xd8, 0x4e, 0x31, 0x99, 0xa8, 0x1b,
0xb1, 0xe2, 0x7b, 0xa4, 0x0d, 0xac, 0x75, 0x7e,
0x31, 0xa9, 0xa0, 0x36, 0x77, 0x3e, 0x90, 0xb5
};
            static readonly byte[] g26_y = {
0x84, 0x74, 0x99, 0xc2, 0xf4, 0x7f, 0x52, 0x16,
0x7f, 0x9c, 0x14, 0xf8, 0x42, 0x29, 0x8b, 0x4c,
0x78, 0x3e, 0x15, 0x1c, 0x5a, 0xa0, 0x62, 0xaf,
0x87, 0xf4, 0x87, 0xdc, 0xac, 0x4c, 0xeb
};

            // g27 (counter = 2)
            static readonly byte[] g27_x = {
0x03, 0xaa, 0x93, 0xdc, 0xe8, 0x97, 0xef, 0x47,
0x38, 0x93, 0xf1, 0xe0, 0x3c, 0x85, 0x76, 0xdb,
0xad, 0xcc, 0x4d, 0x48, 0x5f, 0xa9, 0x33, 0x26,
0x74, 0x24, 0x02, 0x80, 0xd7, 0x7c, 0x4f, 0x50
};
            static readonly byte[] g27_y = {
0x0a, 0x33, 0x6d, 0xf1, 0x42, 0x1b, 0xdf, 0xdc,
0x2a, 0xe6, 0x8d, 0xa8, 0xbb, 0xab, 0x4b, 0x17,
0x40, 0x55, 0x7a, 0xfc, 0x3b, 0xcd, 0x92, 0x27,
0x61, 0x8d, 0x16, 0x6f, 0x3e, 0x16, 0x2d, 0x00
};

            // g28 (counter = 0)
            static readonly byte[] g28_x = {
0x10, 0xa0, 0x4c, 0x54, 0xb4, 0x26, 0x63, 0x3d,
0xed, 0x0b, 0xe4, 0xe3, 0x17, 0x0a, 0xbb, 0x22,
0xa3, 0xc8, 0x8a, 0x67, 0xed, 0x49, 0x71, 0x7a,
0x37, 0x8a, 0xf6, 0xf9, 0x71, 0x91, 0xfe, 0x9b
};
            static readonly byte[] g28_y = {
0x04, 0xea, 0x8e, 0x91, 0xac, 0x60, 0xd0, 0xc2,
0xe1, 0xa6, 0x6e, 0xaa, 0x66, 0x3c, 0xa3, 0x44,
0x55, 0xd0, 0x62, 0x7b, 0x86, 0xb7, 0x6a, 0x85,
0x37, 0x66, 0xf6, 0x73, 0xd2, 0x1e, 0x4e, 0x0f
};

            // g29 (counter = 3)
            static readonly byte[] g29_x = {
0x01, 0xd5, 0x00, 0xdd, 0x75, 0x82, 0x76, 0x60,
0x66, 0xdd, 0x8d, 0x6a, 0xd1, 0x3f, 0xdc, 0x84,
0x97, 0xf6, 0xe8, 0x05, 0x26, 0x86, 0xe4, 0xc6,
0x74, 0x62, 0x87, 0xec, 0x3d, 0xa6, 0x92, 0x7b
};
            static readonly byte[] g29_y = {
0x0e, 0x9b, 0x6c, 0x01, 0xd6, 0xc2, 0x00, 0xb5,
0xa6, 0x88, 0xe9, 0x48, 0xa0, 0x09, 0x1c, 0xc3,
0x53, 0x5a, 0xcf, 0x44, 0x01, 0xe7, 0x72, 0x62,
0xde, 0x90, 0xba, 0x8e, 0x6d, 0x08, 0x85, 0x74
};

            // g30 (counter = 1)
            static readonly byte[] g30_x = {
0x0b, 0xc6, 0x40, 0x5a, 0xda, 0xba, 0x99, 0x56,
0x9c, 0x7b, 0x46, 0x7e, 0xaa, 0x59, 0x4e, 0xa9,
0x02, 0xa0, 0xf6, 0x4f, 0x86, 0x2e, 0xe3, 0x76,
0x4b, 0x97, 0x2c, 0x0c, 0x36, 0x69, 0x74, 0xfd
};
            static readonly byte[] g30_y = {
0x0d, 0xb2, 0x97, 0x62, 0xb9, 0x6c, 0xc5, 0x99,
0xca, 0xcb, 0xb2, 0x84, 0xe2, 0xb8, 0x25, 0x59,
0xf7, 0xbf, 0x65, 0xde, 0x56, 0xec, 0xa3, 0x8a,
0xcf, 0x4a, 0xd7, 0x0b, 0x3c, 0x9a, 0xbc, 0xe7
};

            // g31 (counter = 0)
            static readonly byte[] g31_x = {
0x14, 0xf4, 0x29, 0xc7, 0x60, 0x53, 0x46, 0x27,
0x66, 0xef, 0x65, 0xa9, 0x07, 0x4b, 0x5e, 0x0e,
0x22, 0x85, 0xc6, 0x84, 0x37, 0xd5, 0xc4, 0x8f,
0x3e, 0x3f, 0x05, 0x00, 0x4d, 0xd3, 0x82, 0x1d
};
            static readonly byte[] g31_y = {
0x10, 0xfc, 0x75, 0x6c, 0x92, 0xf6, 0x82, 0x91,
0xf6, 0xc1, 0xae, 0x75, 0x9e, 0x80, 0x69, 0x1b,
0x02, 0x30, 0x74, 0x81, 0x7a, 0xbc, 0x96, 0xfc,
0x6b, 0x6f, 0x27, 0x5b, 0x4d, 0x35, 0x88, 0x16
};

            // g32 (counter = 0)
            static readonly byte[] g32_x = {
0x09, 0xb2, 0x20, 0x7c, 0xd5, 0xa3, 0x8c, 0x46,
0xa8, 0x25, 0x40, 0x49, 0x21, 0x95, 0x77, 0xae,
0x9b, 0xfe, 0xc4, 0x75, 0xaa, 0xf6, 0xd4, 0xd7,
0x24, 0x7f, 0x45, 0x2d, 0x62, 0x99, 0xb2, 0xda
};
            static readonly byte[] g32_y = {
0x0e, 0xf2, 0x34, 0xf3, 0xb4, 0xd3, 0xc2, 0x0a,
0x64, 0x00, 0xb4, 0x8a, 0xf3, 0x36, 0x2a, 0x28,
0x87, 0x20, 0xf4, 0x89, 0x88, 0xbb, 0xb1, 0x18,
0xdd, 0x63, 0x56, 0x0f, 0xd9, 0x5f, 0xfd, 0xfe
};

            // g33 (counter = 1)
            static readonly byte[] g33_x = {
0x18, 0x02, 0x87, 0x23, 0xed, 0x79, 0x01, 0xf6,
0x54, 0x1f, 0x1d, 0x3c, 0xec, 0xbf, 0x29, 0x1e,
0xdd, 0xa6, 0x2e, 0x45, 0xe3, 0x08, 0x4f, 0xe3,
0x6c, 0xce, 0x67, 0xce, 0x61, 0x6b, 0x2a, 0xe2
};
            static readonly byte[] g33_y = {
0x0e, 0xe8, 0x88, 0x83, 0x80, 0x53, 0x85, 0x92,
0x0d, 0x90, 0xe1, 0x95, 0x50, 0xe6, 0x24, 0x4e,
0xa8, 0x07, 0xa7, 0x4a, 0x83, 0x38, 0x89, 0xf4,
0x94, 0x57, 0x97, 0xc3, 0x80, 0xa3, 0x08, 0x33
};

            // g34 (counter = 0)
            static readonly byte[] g34_x = {
0x08, 0x01, 0x06, 0x68, 0x4c, 0x2e, 0xc9, 0x60,
0xa8, 0xe9, 0x63, 0x89, 0xd2, 0x14, 0xaa, 0xf8,
0x19, 0x79, 0x4e, 0x5f, 0xce, 0x41, 0x23, 0x42,
0xbd, 0x66, 0xc3, 0x89, 0x11, 0xea, 0x78, 0xc7
};
            static readonly byte[] g34_y = {
0x07, 0x3f, 0x57, 0x77, 0x15, 0x48, 0xfd, 0x16,
0x84, 0x41, 0x49, 0x9d, 0x6a, 0xb9, 0x47, 0xe2,
0x92, 0x21, 0x19, 0x70, 0x92, 0xb6, 0x31, 0x57,
0x8e, 0xbb, 0xeb, 0x3b, 0x87, 0xa4, 0x60, 0xd8
};

            // g35 (counter = 0)
            static readonly byte[] g35_x = {
0x04, 0x80, 0xa3, 0x93, 0xb8, 0xde, 0xa1, 0xd3,
0x5a, 0x27, 0x7b, 0x79, 0x49, 0xb0, 0x75, 0xbf,
0x98, 0xac, 0x5f, 0x9e, 0x0e, 0x5e, 0xed, 0x99,
0x2d, 0xd2, 0xe5, 0xf3, 0x37, 0xa7, 0xc9, 0x7c
};
            static readonly byte[] g35_y = {
0x0f, 0xe2, 0xec, 0x5e, 0xb7, 0x30, 0x95, 0x7e,
0x45, 0x57, 0x6a, 0xfa, 0x6a, 0x3f, 0xf1, 0x1a,
0x46, 0x5e, 0xc5, 0x3d, 0x7c, 0x0e, 0x9a, 0xae,
0xf8, 0xa0, 0xa6, 0xa4, 0x69, 0xb8, 0x2d, 0x5e
};

            // g36 (counter = 1)
            static readonly byte[] g36_x = {
0x0d, 0x53, 0x65, 0x40, 0x2f, 0x28, 0xf3, 0x0a,
0x7c, 0xa3, 0xcf, 0xe7, 0x8c, 0xb4, 0x3a, 0x0d,
0x2e, 0xd7, 0x6d, 0x85, 0x54, 0x1a, 0xda, 0xce,
0xfc, 0xef, 0x6a, 0xce, 0xc4, 0xd9, 0x5b, 0x53
};
            static readonly byte[] g36_y = {
0x0c, 0xbe, 0x98, 0x3a, 0xdf, 0x5c, 0x87, 0xa1,
0xfe, 0xbe, 0xbc, 0x1e, 0xe2, 0xd8, 0xda, 0x3d,
0x08, 0xa9, 0x1b, 0xfd, 0x3a, 0xc5, 0x61, 0x34,
0xa9, 0x8f, 0x3b, 0xe8, 0x00, 0x6d, 0xe5, 0xfd
};

            // g37 (counter = 0)
            static readonly byte[] g37_x = {
0x0b, 0x9e, 0xe8, 0xb9, 0x8b, 0x6b, 0x5e, 0x68,
0xb6, 0xdb, 0x8e, 0x3f, 0x9d, 0x2c, 0x02, 0x89,
0x18, 0x09, 0xac, 0x9e, 0x0d, 0xcf, 0x0f, 0x14,
0xb2, 0x15, 0x8b, 0x84, 0xac, 0xb6, 0xe2, 0x47
};
            static readonly byte[] g37_y = {
0x06, 0xcb, 0xbc, 0xe0, 0xdf, 0xf8, 0x7a, 0xc6,
0x1c, 0x7c, 0x75, 0x5a, 0xe4, 0x95, 0x59, 0xef,
0x93, 0x97, 0x3d, 0x82, 0x7f, 0xc3, 0x8d, 0xb6,
0x19, 0xc8, 0xab, 0xa7, 0x2e, 0xaa, 0x87, 0x41
};

            // g38 (counter = 0)
            static readonly byte[] g38_x = {
0x02, 0x16, 0xb1, 0xc1, 0x1e, 0x51, 0xd5, 0xe6,
0x9f, 0xc9, 0x31, 0x96, 0xfa, 0x17, 0x52, 0x4c,
0x91, 0x95, 0x60, 0x9f, 0xff, 0xc5, 0xe8, 0x87,
0x94, 0x4f, 0xa3, 0x07, 0xca, 0xc2, 0x43, 0x91
};
            static readonly byte[] g38_y = {
0x07, 0x44, 0xdc, 0xb5, 0xf3, 0xe0, 0xab, 0x8c,
0xaf, 0x24, 0xc7, 0xad, 0x35, 0x31, 0xe1, 0x54,
0x44, 0x64, 0x71, 0xcf, 0x48, 0x3e, 0xd4, 0x44,
0x94, 0x08, 0x92, 0x57, 0xc3, 0xfb, 0x92, 0x44
};

            // g39 (counter = 0)
            static readonly byte[] g39_x = {
0x17, 0x15, 0xd9, 0xba, 0x6f, 0xbe, 0xa9, 0x8f,
0xe1, 0x6d, 0xa2, 0x7d, 0xc0, 0xc3, 0x80, 0xe3,
0x4c, 0x0c, 0x38, 0x30, 0x3d, 0xe6, 0x78, 0x5a,
0xfe, 0xd3, 0xd0, 0xfe, 0x79, 0x48, 0x22, 0x64
};
            static readonly byte[] g39_y = {
0x86, 0x14, 0x4a, 0x2f, 0xc4, 0xab, 0x82, 0xfe,
0xfa, 0x37, 0x31, 0xf2, 0x55, 0xb4, 0x4d, 0x64,
0xfb, 0xc5, 0xa0, 0x3b, 0x3c, 0x0c, 0x97, 0xf9,
0xfa, 0x3d, 0xef, 0xc9, 0xb9, 0xe9, 0x4d
};

            // g40 (counter = 3)
            static readonly byte[] g40_x = {
0x03, 0x8a, 0xc1, 0x63, 0x7f, 0xef, 0x73, 0xff,
0x52, 0xe5, 0x97, 0x35, 0xce, 0x92, 0x94, 0x21,
0x62, 0xb9, 0xe6, 0x4a, 0x06, 0x08, 0xff, 0xc9,
0x6c, 0x5e, 0x31, 0xa0, 0x86, 0x55, 0xb1, 0x58
};
            static readonly byte[] g40_y = {
0x03, 0xb6, 0x2a, 0x4e, 0x3d, 0x47, 0x18, 0x03,
0x65, 0xde, 0xe6, 0xa4, 0xa4, 0xe6, 0xbe, 0x18,
0x28, 0xc8, 0x6f, 0xfd, 0x5a, 0x07, 0xae, 0x2b,
0xc0, 0xaa, 0x70, 0x4d, 0x93, 0x1c, 0x0a
};

            // g41 (counter = 3)
            static readonly byte[] g41_x = {
0x20, 0x45, 0xb7, 0xc8, 0x0b, 0x16, 0xcc, 0x6b,
0xe4, 0xa3, 0xa8, 0x18, 0x11, 0xfa, 0x0f, 0x26,
0xff, 0xaf, 0xa7, 0x3d, 0x96, 0x94, 0xb8, 0x47,
0xfc, 0xb2, 0xfd, 0x03, 0x1d, 0xc5, 0xd4, 0x92
};
            static readonly byte[] g41_y = {
0x10, 0x3b, 0x4e, 0x10, 0x58, 0x79, 0x90, 0x6c,
0xc1, 0x28, 0x96, 0xdb, 0x3c, 0x7f, 0xc6, 0xd3,
0xae, 0xe0, 0x76, 0x77, 0x30, 0x1c, 0x9e, 0x62,
0x38, 0xd2, 0x50, 0x35, 0x5b, 0x17, 0x4b, 0xb4
};

            // g42 (counter = 0)
            static readonly byte[] g42_x = {
0x03, 0xa7, 0x5f, 0x05, 0x61, 0x6c, 0x23, 0xc9,
0xcc, 0x5e, 0xf9, 0xed, 0x4d, 0xd3, 0xcd, 0x95,
0xe6, 0xc2, 0xc0, 0xa1, 0x68, 0x07, 0x69, 0x29,
0xce, 0x26, 0xbb, 0x87, 0xd3, 0xb4, 0xb7, 0x98
};
            static readonly byte[] g42_y = {
0x09, 0xa4, 0x46, 0x8d, 0x7a, 0x2f, 0x1d, 0xbe,
0x7a, 0x78, 0xb5, 0xe1, 0x36, 0x0f, 0x6d, 0x72,
0xf7, 0xae, 0xd5, 0xcf, 0x07, 0x5d, 0x47, 0xa5,
0x85, 0x6d, 0xef, 0xab, 0xba, 0xfe, 0xaa, 0xe5
};

            // g43 (counter = 3)
            static readonly byte[] g43_x = {
0x04, 0x32, 0x56, 0x7b, 0x02, 0x56, 0xbf, 0x2e,
0x63, 0x81, 0xb3, 0x42, 0x69, 0x25, 0x8d, 0x59,
0xb2, 0x53, 0xa6, 0x56, 0xbc, 0xe8, 0x9b, 0x20,
0x0b, 0x3b, 0xd9, 0xbe, 0xb6, 0xc3, 0xed, 0xe4
};
            static readonly byte[] g43_y = {
0x0e, 0xa8, 0xbb, 0x79, 0x99, 0xa7, 0xaf, 0xfd,
0x66, 0x14, 0x0a, 0xaa, 0x72, 0x1b, 0x77, 0xe3,
0x91, 0x67, 0x8b, 0x42, 0xee, 0xda, 0xa3, 0x87,
0xb2, 0xd3, 0xd1, 0x97, 0x39, 0x1e, 0x5f, 0x02
};

            // g44 (counter = 0)
            static readonly byte[] g44_x = {
0x0a, 0x47, 0x39, 0xb0, 0x93, 0x1d, 0x77, 0xea,
0xcf, 0xb3, 0x90, 0x36, 0x27, 0xbd, 0x9a, 0x06,
0xd3, 0x2e, 0x37, 0xa2, 0xd7, 0x6d, 0x73, 0x34,
0x3c, 0x6e, 0x5e, 0x31, 0x16, 0x34, 0xa3, 0x09
};
            static readonly byte[] g44_y = {
0x05, 0xc9, 0x22, 0xbb, 0xd3, 0xb0, 0x8b, 0xe1,
0xab, 0xc2, 0x55, 0xeb, 0xd2, 0xa0, 0x33, 0x5a,
0x96, 0x1c, 0x75, 0xa1, 0x0b, 0xaf, 0x4f, 0xe3,
0x62, 0x47, 0x83, 0x86, 0xac, 0xad, 0x7a, 0xc8
};

            // g45 (counter = 0)
            static readonly byte[] g45_x = {
0x0b, 0x8a, 0x2a, 0x7d, 0x60, 0x81, 0x8e, 0x7f,
0xa7, 0x10, 0xc1, 0x24, 0x21, 0xaa, 0xfa, 0x06,
0xc9, 0xed, 0x5b, 0x55, 0xe8, 0xa7, 0x01, 0xf3,
0x55, 0xe7, 0xef, 0x40, 0xa0, 0xfb, 0x05, 0x74
};
            static readonly byte[] g45_y = {
0x10, 0x14, 0x1e, 0xb7, 0x97, 0xd5, 0x93, 0x95,
0xc2, 0xfe, 0x06, 0x1f, 0xc1, 0x5d, 0x67, 0x99,
0xd7, 0x4a, 0x81, 0x9a, 0xca, 0xe5, 0xc5, 0x76,
0x0c, 0xad, 0x18, 0x2c, 0xd7, 0xf4, 0x0a, 0x4e
};

            // g46 (counter = 1)
            static readonly byte[] g46_x = {
0x02, 0x03, 0xc6, 0x8e, 0xb0, 0x30, 0x56, 0x7f,
0x49, 0xad, 0xbb, 0xed, 0x92, 0x4a, 0xbe, 0x0b,
0xf2, 0xff, 0x85, 0x06, 0xe2, 0xc5, 0x00, 0x8b,
0x9a, 0xd4, 0x6f, 0xc7, 0x46, 0xd7, 0x1a, 0xbd
};
            static readonly byte[] g46_y = {
0xa5, 0x10, 0xde, 0xa0, 0x8b, 0x9d, 0x6d, 0xb0,
0x2f, 0x0c, 0xa6, 0xc5, 0xa6, 0x84, 0x1b, 0x75,
0x52, 0x7a, 0x74, 0x7f, 0x69, 0xb7, 0xce, 0x6a,
0x61, 0x0e, 0xfc, 0x90, 0xcc, 0x19, 0x6b
};

            // g47 (counter = 0)
            static readonly byte[] g47_x = {
0x0a, 0x00, 0xa2, 0x85, 0xf2, 0x73, 0xa4, 0x10,
0x39, 0x97, 0x13, 0x75, 0xce, 0x5d, 0x15, 0x27,
0x0a, 0xd1, 0xcf, 0xe0, 0x6d, 0xe4, 0x05, 0x0e,
0x0f, 0x10, 0x16, 0x82, 0x6e, 0xe8, 0x4a, 0x11
};
            static readonly byte[] g47_y = {
0x09, 0xf8, 0x5f, 0x8a, 0xc1, 0x0e, 0x92, 0xc7,
0x12, 0x12, 0x93, 0x41, 0xdc, 0xc9, 0xd4, 0x24,
0xd3, 0xb6, 0xe0, 0x5f, 0xff, 0x5e, 0xb8, 0x2b,
0xf4, 0x26, 0x5e, 0x19, 0x8d, 0x19, 0x92, 0x0a
};

            // g48 (counter = 2)
            static readonly byte[] g48_x = {
0x16, 0xd3, 0xbe, 0x36, 0xf0, 0x3e, 0x5c, 0x47,
0xcc, 0x1a, 0xd6, 0x56, 0xc9, 0xa9, 0x64, 0x0e,
0xe4, 0xfe, 0xa5, 0x26, 0xe9, 0x10, 0x64, 0x19,
0xbc, 0x62, 0x66, 0x73, 0x5e, 0xda, 0xbf, 0x08
};
            static readonly byte[] g48_y = {
0x02, 0x2e, 0xd1, 0x36, 0x37, 0xb6, 0x0d, 0xc6,
0x84, 0x2c, 0xe1, 0x9d, 0xa8, 0xcc, 0x90, 0x44,
0xae, 0x3e, 0xfc, 0xcd, 0x54, 0x45, 0x49, 0xc9,
0xa5, 0xb4, 0x88, 0x65, 0x29, 0xf4, 0xaa, 0xf6
};

            // g49 (counter = 1)
            static readonly byte[] g49_x = {
0x12, 0x48, 0xee, 0x00, 0xbc, 0x7e, 0xcd, 0x49,
0x69, 0x2f, 0xb6, 0x63, 0xf8, 0x2a, 0x60, 0x48,
0xe1, 0x2f, 0x6f, 0x10, 0x29, 0x11, 0x04, 0x8b,
0x66, 0xb4, 0xa5, 0x16, 0xc0, 0xcc, 0x75, 0xf4
};
            static readonly byte[] g49_y = {
0x0d, 0x47, 0x83, 0x0a, 0xb4, 0xe5, 0x73, 0xd6,
0x4c, 0x5c, 0xc7, 0xe3, 0xe2, 0x7f, 0x8a, 0x30,
0x18, 0x8f, 0xb9, 0x59, 0x07, 0x0c, 0x9c, 0xd1,
0xf7, 0x63, 0x05, 0x6d, 0xd1, 0xd2, 0x3e, 0xd0
};

            // g50 (counter = 0)
            static readonly byte[] g50_x = {
0x06, 0xca, 0x1d, 0x10, 0x44, 0xfe, 0xd6, 0x49,
0xff, 0x12, 0xbd, 0x53, 0x13, 0x1d, 0x89, 0x29,
0x10, 0x7f, 0xd9, 0xba, 0x35, 0x4f, 0xf1, 0xd0,
0x22, 0xd3, 0x7e, 0x44, 0x19, 0x45, 0x9d, 0xfe
};
            static readonly byte[] g50_y = {
0x04, 0x04, 0x81, 0x28, 0xc2, 0xb6, 0x15, 0x51,
0xb9, 0x67, 0x44, 0xa1, 0x7b, 0x04, 0x2b, 0x9c,
0x28, 0x44, 0x12, 0xb4, 0xc0, 0xfc, 0x19, 0xc0,
0xd4, 0x12, 0x1d, 0x47, 0x10, 0x08, 0x52, 0xce
};

            // gt (counter = 1)
            static readonly byte[] gt_x = {
0x18, 0xc4, 0x16, 0xc1, 0xbc, 0x06, 0x7e, 0x09,
0x6b, 0x45, 0xdf, 0x7f, 0x9f, 0xe9, 0xdf, 0xba,
0x04, 0xb3, 0xa9, 0xc6, 0xfe, 0x04, 0x11, 0x8d,
0x6e, 0x1c, 0x8d, 0xb2, 0x3b, 0x8e, 0x92, 0x1b
};
            static readonly byte[] gt_y = {
0x04, 0x93, 0x1d, 0xec, 0xd5, 0x4b, 0x1e, 0xb4,
0x8c, 0x96, 0x67, 0x93, 0xb9, 0x37, 0xfd, 0x92,
0x0d, 0x59, 0x93, 0x26, 0x32, 0x2f, 0x06, 0x96,
0xe9, 0xa4, 0x85, 0xd5, 0xd1, 0xc0, 0xd6, 0xba
};

            // gd (counter = 0)
            static readonly byte[] gd_x = {
0x07, 0x55, 0x5d, 0x2e, 0xc4, 0x3f, 0x3b, 0x4a,
0x86, 0x9d, 0x5e, 0xe3, 0x2a, 0xd9, 0x28, 0xd4,
0x68, 0xa3, 0x59, 0xc1, 0x7b, 0x65, 0x24, 0x72,
0x99, 0xd6, 0xc3, 0xde, 0xc1, 0x5a, 0xe0, 0x5b
};
            static readonly byte[] gd_y = {
0xb6, 0x05, 0x5c, 0x5a, 0x2d, 0xae, 0x65, 0xdf,
0x97, 0x5b, 0x42, 0xe5, 0xe9, 0xc6, 0xb5, 0x85,
0x1a, 0x0d, 0xe9, 0x9c, 0x7d, 0x82, 0x90, 0x90,
0x97, 0x59, 0xc0, 0xee, 0x65, 0x2b, 0xc4
};

            private static readonly ECGroup ecGroup = ECGroup.CreateECGroup(p, a, b, g_x, g_y, n, ParamSet_EC_BN254_V1Name, "BN254");
