...
namespace UProveCryptoTest
{
    ...
    public class TestVectorsTest
    {
        ...
        IssuerKeyAndParameters LoadIssuerKeyAndParameters(string oid, bool supportDevice, Dictionary<string, string> vectors)
        {
        ...
        public void ProtocolTest()
        {
            ...
            foreach (bool supportDevice in bools)
            {
                foreach (int DSize in new int[] { 0, 2, 5 })
                {
                    ...
                    {
                        string filename = "TestVectorData/testvectors_";
                        filename += "EC";
                        if (supportDevice)
                        {
                            filename += "_Device";
                        ...
                        IssuerKeyAndParameters ikap = LoadIssuerKeyAndParameters(vectors["GroupName"], supportDevice, vectors);
